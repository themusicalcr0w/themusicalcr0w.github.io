(() => {
  const labels = {
    world: "PopulateWorld.gd",
    memory: "GeneratedDialogueService.gd + ObservedBodySnapshot.gd",
    journal: "JournalPageCurlRenderer.gd",
    genetics: "GeneticInheritanceResolver.gd",
    save: "SaveGameManager.gd"
  };
